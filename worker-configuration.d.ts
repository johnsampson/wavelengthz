/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0aa642be49a15492fc2bed1f7dcd7ca9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SPOTIFY_REDIRECT_URI">> {}
}
