...
You must be at least 18 years old to create an account. We ask for your date
of birth during onboarding and block account creation outright if it works
out to under 18 — there's no warning-and-continue path. Don't create an
account on behalf of someone else, and don't misrepresent your age, identity,
or location.

## 2. Your account

You sign up by connecting a Spotify or Google account — we don't collect a
separate password. Keep the credentials to that connected account secure;
...
instant: your account enters a 7-day grace period during which you can sign
back in to cancel the deletion, after which it's permanently and
irreversibly purged, including your photos, messages, and match history.

## 3. What Wavelengthz is for

Wavelengthz connects people based on musical taste — pulled from your
Spotify listening history — for the purpose of matching and messaging other
real people looking to do the same. It is not a platform for advertising,
soliciting, impersonating someone else, or any purpose besides genuine,
person-to-person connection.

## 4. Content you provide

You're responsible for your profile photos, bio, and messages. By posting
...
Messaging unlocks once your profile is complete: a bio and at least one
photo. This exists so the people you match with have something to actually
respond to, not to gatekeep casual use of the app.

We may screen outgoing messages for abuse before they're delivered. If
messages are blocked or restricted for policy reasons, we'll tell you which
rule applied where practical.

## 6. Reporting, blocking, and account status

**Blocking** a person hides them from you and you from them, in both
directions, immediately, and is entirely your own choice — it doesn't affect
anyone's account beyond your own view of them.

**Reporting** flags a person's account for review. If enough different
people report the same account, that account is automatically restricted
from view — its owner is not notified when this happens. We do this because
...
We use an approximate location you provide to show you people nearby and to
let others filter by distance. We don't display your exact address to other
users.
